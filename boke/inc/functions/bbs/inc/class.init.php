 ...
 * @LastEditTime: 2023-10-26 12:07:16
...
class zib_bbs
{
    ...
    public function setup()
    {
        ...
        add_action('quick_edit_custom_box', array($this, 'bulk_edit_custom_box'), 10, 2);
        add_action('save_post', array($this, 'bulk_save_post'), 10, 3);
