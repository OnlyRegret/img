 ...
 * @LastEditTime: 2023-10-26 20:32:48
...
function zib_user_page_header()
{
    ...
    if ($user_id) {
        ...
        $info_html_flex1 .= '<div class="desc user-identity flex ac hh"><span class="but" style="--this-bg: linear-gradient(43deg, #ff6ac34a 0%, #82e1ff 46%, #ff6ac34a 100%);--this-color: #ff5473;"><img src="'.vxras_pz('static_vxras').'/img/toast1.png" style="max-width: 30px;">加入小窝'.zib_get_user_join_days($user_id).'天啦～</span>' . $desc . '</div>';
        $info_html_flex1 .= '</div>';
    } else {
    ...
    $info_html .= $avatar.'<div class="desc user-identity" style="text-align: center;"><span class="but c-red" data-clipboard-tag="ID" data-clipboard-text="'.$user_id.'"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-user-color"></use></svg>UID:'.$user_id.'</span></div>';
    $info_html .= '</div>';
