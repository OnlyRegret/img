 ...
 * @LastEditTime: 2023-10-31 00:46:38
...
function zib_menu_button($layout = 1)
{
    ...
    if (!zib_is_close_sign(true)) {
        ...
        if (2 == $layout) {
            ...
            if ($user_id) {
                ...
                $sign_but = '<li class="signin-loader"><a href="javascript:;" class="navbar-avatar">' . $avatar . '</a><ul class="sub-menu">' . $user_sub . '</ul></li>';
            }
        } else {
    //         $sign_but = '<li><a href="javascript:;" class="btn' . ($user_id ? '' : ' signin-loader') . '">' . zib_get_svg('user', '50 0 924 924') . '</a>
				...
				// 			</ul>
				// 		</li>';
				$sign_but = '<li class="signin-loader"" class="btn' . ($user_id ? '' : ' signin-loader') . '"><div class="navbar-avatar">' . zib_get_data_avatar($user_id) . '</div>
                            <ul class="sub-menu">
                            ' . $user_sub . '
                            </ul>
                        </li>';
...
function zib_header_user_box()
{
    ...
    if ($user_id) {
        ...
        $href .= '<div class="header-login-button signin-loader">
        <div class="acg-login-avatar"></div>
        <div class="user-inner"><div class="user-inner-main"><img src="/wp-content/themes/vxras/img/loginee.png" class="mascot"> <p class="explain">主人，请点击头像登录后查看哦~</p></div></div>
        </div><div class="flex jsa header-user-href">';
