 ...
 * @LastEditTime: 2023-11-10 21:21:33
...
function zib_upload_modal($args = array(), $echo = true)
{
    $defaults = array(
        ...
        'class'         => '',
        'style'         => '',
        'before'        => '<h4><i class="fa fa-cloud-upload em12 mr10 focus-color"></i></h4><h4>上传图片</h4><div class="muted-2-color">请选择上传图片，支持jpg/png/gif，大小不能超过' . zib_get_current_user_can_number('upload_img_size', 3) . 'M</div>',
        'after'         => '',
        'action_url'    => '',
...
function zib_submit_links_card($args = array())
{
    ...
    $card .= '<div class="form-group">
                ...
                &nbsp;<span class= "newadd-btns but pw-1em jb-pink btn-newadd"  id="link_deta"  href="javascript:;" type="radio" name="type" onclick="sub()" ><i class="fa fa-search mr10"></i>一键获取</span>  
...
// array变成二维数组，design：表情统称，suffix：表情格式后缀，name：就是原来的名字
        $smilie_icon_args = array(
                ...
                array(
                        'design' => '枕边童话',
                        'suffix' => '.gif',
                        'name' => array('咩栗_啊这','咩栗_欸','咩栗_拜拜','咩栗_比心','咩栗_戳','咩栗_气气','咩栗_歪脑','咩栗_委屈巴巴','咩栗_呜呜','咩栗_小棉花','呜米_比心','呜米_吃瓜','呜米_戳','呜米_果咩捏','呜米_哈哈哈','呜米_嘿嘿嘿','呜米_敲打','呜米_歪头','呜米_小米星','呜米_ok','枕边童话_抱抱','枕边童话_探头','枕边童话_贴贴','枕边童话_晚安','枕边童话_rua')
                ),
    );
        $smilie_icon      = '';
        $img_url          = '' . get_bloginfo('url') . '/wp-content/themes/vxras/img/smilies/';
