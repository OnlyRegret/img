        ...
        <div class="flex1 ml10">
            ...
            <div class="but mt10 p2-10 c-blue btn-block px12">查看详情</div>
                ...
                'fields'   => array(
                    array(
                        'title'      => '繁简切换',
                        'desc'       => '<div class="c-yellow"><i class="fa fa-fw fa-info-circle fa-fw"></i>此按钮建议放置在返回顶部上方</div>',
...
<div class="px12 opacity5">部分邀请码还可获取丰厚奖励<br>获取邀请码请与客服联系</div>',
            ...
            array(
                'title'    => __('用户邮箱限制', 'zib_language').$new_badge['7.5'],
                'subtitle' => __('禁止注册、修改的邮箱关键词', 'zib_language'),
                'desc'     => __('前台注册或修改邮箱时，不能使用包含这些关键字的邮箱(请用逗号或换行分割)<br>用于禁止某个邮箱号、某个邮箱后缀、某包含字符就禁止注册，例如：<code>123123@</code><code>@gmail.com</code>', 'zib_language'),
                'id'       => 'user_email_out',
                'default'  => "",
                'sanitize' => false,
                'type'     => 'textarea',
