 ...
 * @LastEditTime: 2023-11-01 14:59:50
 ...
 * @return {*}
 */
function zib_get_quick_edit_custom_input($fields_args, $class = '', $desc = '')
{
    ...
    foreach ($fields_args as $fields) {
        ...
        switch ($fields['type']) {
            case 'radio':
                ...
                $radio_options_html = '<div class="mr10"><label style="line-height: 1;"><input checked="checked" type="radio" name="zib_bulk_edit[' . $fields['id'] . ']" value="ignore"><span class="opacity8">不更改</span></label></div>';
                foreach ($radio_options as $key => $value) {
                    $radio_options_html .= '<div class="mr10"><label style="line-height: 1;"><input type="radio" name="zib_bulk_edit[' . $fields['id'] . ']" value="' . $key . '"><span class="opacity8">' . $value . '</span></label></div>';
                }
            ...
            case 'number':
                $options_html = '<div class="flex ac hh mb10">
                                    <select name="zib_bulk_edit[' . $fields['id'] . '][operation]">
                                    ...
                                    <input type="number" name="zib_bulk_edit[' . $fields['id'] . '][val]" value="">
                                </div>';
    ...
    return $item_html ? '<fieldset class="' . $class . '"><div class="flex hh">' . $item_html . '</div>' . $desc . '</fieldset>' : '';
}
