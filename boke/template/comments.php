 ...
 * @LastEditTime: 2023-09-23 23:12:41
 */
						...
						<div class="comt-box grow1">
							...
							<div class="comt-ctrl relative">
								...
								<div class="comt-tips-right pull-right">
									...
									<label class="pw-1em simi" data-placement="top" data-toggle="tooltip" title="你的评论仅评论双方可见。" style="margin-bottom: 0px;background: #ff6ea259;border-radius: 6px;padding: .3em 1em; color: #fc6976;">
                            <input name="is-private" type="checkbox">&nbsp;&nbsp;&nbsp;私密</label>&nbsp;
                            <style>@media screen and (min-width: 850px){.simi::before{content:'';position:absolute;width:70px;top:-30px;height:35px;background:url(<?php echo vxras_pz('static_vxras');?>/img/share_topbar.png) no-repeat center / 100%;}}</style>
			...
			<ol class="commentlist list-unstyled">
				...
				if(!zib_current_user_can('comment_view',$post)){
					...
					if (_pz('comment_corderby', true) && _pz('comment_like_s', true)) {
						...
						$item = '<li class="mr6' . (!$corderby || $corderby == 'comment_date_gmt' ? ' active' : '') . '"><a class="comment-orderby" href="' . esc_url(add_query_arg('corderby', 'comment_date_gmt', $url)) . '">最新</a></li>';
						$item .= '<li class="' . ($corderby == 'comment_like' ? 'active' : '') . '"><a class="comment-orderby" href="' . esc_url(add_query_arg('corderby', 'comment_like', $url)) . '">最热</a></li>';
						...
						$only_author      = '<a class="but comment-orderby btn-only-author p2-10" href="' . esc_url(add_query_arg('only_author', ($only_author ? false : $author_id), $url)) . '">' . $only_author_text . '</a>';
