 ...
 * @LastEditTime: 2023-10-26 13:01:56
...
function zibpay_get_pay_uservip_modal()
{
    ...
    $vip_more        = $points_exchange ? $points_exchange . $vip_more : $vip_more;
        ...
        $tab_c .= '<div class="tab-pane fade' . ($vip_level == $vi ? ' active in' : '') . '" id="tab-payvip-' . $vi . '">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-sm-7"><div class="mb10 charge-box">' . $vip_product_html . '</div>' . $vip_more . $pay_button . '</div>
                            </div>
                            ' . $payvip_form . '
                        </form>
                    </div>';
...
function zibpay_get_vip_points_exchange_modal()
{
    ...
    <a class="flex jsb ac" href="' . zib_get_user_center_url('balance') . '">
