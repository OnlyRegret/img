<?php
/**
 * Template name: Zbacg-抖音去水印
 * Description:   douyin page
 * Author: 李初一
 * Url: www.vxras.com
 */
 get_header(); ?>
            ...
            <article class="article wp-posts-content">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="resultLink" class="col-sm-2 control-label">视频标题</label>
                            <input type="text" class="form-control" id="resultdesc" value="<?php echo $desc; ?>"  style="width:100%;">
                        </div>
                        
                        <div class="form-group">
                            <label for="resultLink" class="col-sm-2 control-label">无水印链接</label>
                            <input type="text" class="form-control" id="resultLink" value="<?php echo $finalUrl; ?>"  style="width:100%;">
                        </div>
                        <div class="form-group text-center">
                            <span class="but c-red" data-clipboard-tag="链接" data-clipboard-text="<?php echo $finalUrl; ?>"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-user-color"></use></svg>点击复制链接</span>
                        </div>
